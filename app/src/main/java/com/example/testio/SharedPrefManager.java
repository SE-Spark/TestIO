...
public class SharedPrefManager {
    ...
    private static final String KEY_STUDENT_LEVEL = "studentLevel";
    ...
    public  void fetchStudents(Student student){
        SharedPreferences sharedPreferences = mCtx.getSharedPreferences(SHARED_PREF_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(KEY_STUDENT_NAME,student.getStudentName());
        editor.putString(KEY_STUDENT_CODE,student.getCode());
        editor.putString(KEY_STUDENT_LEVEL,student.getLevel());
        editor.putString(KEY_PARENT_NAME,student.getParentName());
        editor.putString(KEY_PARENT_PHONE,student.getParentPhone());
        editor.apply();
    }
